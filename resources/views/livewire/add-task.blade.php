<div class="new-task p-12 bg-gray-200">
    <h2>New Task</h2>
    <form wire:submit.prevent='submit' class="flex justify-stretch">
        ...
        <button type="submit" class="rounded-r-lg bg-gray-100 flex items-center p-2 border border-gray-400">
